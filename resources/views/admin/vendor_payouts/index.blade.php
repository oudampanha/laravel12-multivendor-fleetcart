      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table table-striped table-bordered" id="vendorPayoutsTable">
            ...
            <tbody>
              @forelse($vendorPayouts ?? [] as $payout)
              <tr>
                <td>{{ $payout->id }}</td>
                <td>
                  @if($payout->vendor)
                ...
                <td>
                  ...
                  @elseif($payout->payout_method === 'paypal')
                    <span class="badge badge-primary">PayPal</span>
                  @elseif($payout->payout_method === 'stripe')
                    <span class="badge badge-success">Stripe</span>
                  @else
                    <span class="badge badge-secondary">{{ $payout->payout_method }}</span>
                  @endif
                </td>
                <td>
