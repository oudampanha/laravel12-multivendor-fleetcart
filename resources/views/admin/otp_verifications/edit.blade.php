...
@section('pageTitle', 'Edit Otp Verification')
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Edit Otp Verification</h4>
      ...
      <div class="card-body">
        <form action="{{ route('admin.otp_verifications.update', $otpVerification->id) }}" method="POST" enctype="multipart/form-data">
          ...
          @php
            $attrs = method_exists($otpVerification ?? null, 'getAttributes') ? $otpVerification->getAttributes() : (array)($otpVerification ?? []);
          @endphp
