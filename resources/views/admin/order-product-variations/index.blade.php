...
@section('pageTitle', 'Order Product Variations Management')
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Order Product Variations Management</h4>
        <div class="card-tools">
          <a href="{{ route('admin.order-product-variations.create') }}" class="btn btn-primary">
            <i class="fas fa-plus"></i> Add New Order Product Variation
          </a>
        </div>
      </div>
      <div class="card-body">
          ...
          <table class="table table-striped table-bordered" id="dataTable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="btn-group">
                    <a href="{{ route('admin.order-product-variations.show', $item->id) }}" class="btn btn-sm btn-info">
                      <i class="fas fa-eye"></i>
                    </a>
                    <a href="{{ route('admin.order-product-variations.edit', $item->id) }}" class="btn btn-sm btn-warning">
                      <i class="fas fa-edit"></i>
                    </a>
                    <form action="{{ route('admin.order-product-variations.destroy', $item->id) }}" method="POST" class="d-inline">
                      @csrf
                      @method('DELETE')
