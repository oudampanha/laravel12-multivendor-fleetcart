...
@section('pageTitle', 'Edit Throttle')
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Edit Throttle</h4>
...
@endif
      ...
      <div class="card-body">
        @if (Route::has('admin.throttles.update'))
<form action="{{ route('admin.throttles.update', $item->id ?? 0) }}" method="POST" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control @error('ip') is-invalid @enderror" 
                   id="ip" name="ip" value="{{ old('ip', $item->ip ?? '') }}">
            @error('ip')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control @error('last_activity_at') is-invalid @enderror" 
                   id="last_activity_at" name="last_activity_at" value="{{ old('last_activity_at', $item->last_activity_at ?? '') }}">
          ...
          <div class="form-group">
            <button type="submit" class="btn btn-primary">
              <i class="fas fa-save"></i> Update Throttle
            </button>
            @if (Route::has('admin.throttles.index'))
