...
<div class="row">
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        <form action="{{ route('admin.vendor_withdrawals.update', $vendorWithdrawal->id) }}" method="POST" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          ...
          <div class="form-group">
            ...
            <a href="{{ route('admin.vendor_withdrawals.index') }}" class="btn btn-secondary ml-2">
