...
@section('pageTitle', 'Vendor Settings Management')
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table class="table table-striped table-bordered" id="vendor_settingsTable">
            <thead>
              <tr>
                <th>ID</th>
                <th>Name</th>
            ...
            <tbody>
              @forelse($vendor_settings ?? [] as $item)
              <tr>
                <td>{{ $item->id }}</td>
                <td>
...
$(document).ready(function() {
  $('#vendor_settingsTable').DataTable({
    responsive: true,
    order: [[0, 'desc']],
    pageLength: 25
  });
