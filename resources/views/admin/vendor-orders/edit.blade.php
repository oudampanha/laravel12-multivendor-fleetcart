...
@section('pageTitle', 'Edit Vendor Order')
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Edit Vendor Order</h4>
      ...
      <div class="card-body">
        @if (Route::has('admin.vendor_orders.update'))
<form action="{{ route('admin.vendor_orders.update', $vendorOrder->id) }}" method="POST" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          ...
          <div class="form-group">
            ...
            <a href="{{ route('admin.vendor-orders.index') }}" class="btn btn-secondary ml-2">
