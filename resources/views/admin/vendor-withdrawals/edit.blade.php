...
@section('pageTitle', 'Edit Vendor Withdrawal')
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Edit Vendor Withdrawal</h4>
        ...
        <div class="card-body">
          <form action="{{ route('admin.vendor-withdrawals.update', $vendorWithdrawal->id) }}" method="POST"
            ...
            <div class="form-group">
              ...
              <a href="{{ route('admin.vendor-withdrawals.index') }}" class="btn btn-secondary ml-2">
