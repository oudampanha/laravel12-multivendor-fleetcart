...
@section('pageTitle', 'Edit Attribute Set')
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Edit Attribute Set</h4>
      ...
      <div class="card-body">
        <form action="{{ route('admin.attribute_sets.update', $attributeSet->id) }}" method="POST" enctype="multipart/form-data">
          ...
          @php
            $attrs = method_exists($attributeSet ?? null, 'getAttributes') ? $attributeSet->getAttributes() : (array)($attributeSet ?? []);
          @endphp
