...
@section('pageTitle', 'Search Terms Management')
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table class="table table-striped table-bordered" id="search_termsTable">
            <thead>
              <tr>
                <th>ID</th>
                <th>Name</th>
