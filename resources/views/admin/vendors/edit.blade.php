    ...
    <div class="card">
      ...
      <div class="card-body">
        <form action="{{ route('admin.vendors.update', $vendor->id) }}" method="POST" enctype="multipart/form-data">
          ...
          @php
            $attrs = method_exists($vendor ?? null, 'getAttributes') ? $vendor->getAttributes() : (array)($vendor ?? []);
          @endphp
          ...
          <div class="form-group">
            ...
            <a href="{{ route('admin.vendors.index') }}" class="btn btn-secondary ml-2">
