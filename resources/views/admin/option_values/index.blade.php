...
@section('pageTitle', 'Option Values Management')
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Option Values Management</h4>
        <div class="card-tools">
          <a href="{{ route('admin.option-values.create') }}" class="btn btn-primary">
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table class="table table-striped table-bordered" id="option_valuesTable">
            <thead>
              <tr>
                <th>ID</th>
                <th>Name</th>
...
@endif
                    ...
                    <form action="{{ route('admin.option-values.destroy', $item->id) }}" method="POST" class="d-inline">
                      @csrf
                      @method('DELETE')
