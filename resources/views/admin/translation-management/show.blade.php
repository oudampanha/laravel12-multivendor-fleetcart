    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="card-tools">
          ...
          <a href="{{ route('admin.translation_management.edit', $item->id ?? 0) }}" class="btn btn-warning">
        ...
        <div class="row mt-4">
          <div class="col-12">
            <div class="btn-group">
              ...
              <form action="{{ route('admin.translation_management.destroy', $item->id ?? 0) }}" method="POST" class="d-inline ml-2">
                @csrf
                @method('DELETE')
