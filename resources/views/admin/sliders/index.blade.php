...
@section('pageTitle', 'Sliders Management')
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Sliders Management</h4>
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table class="table table-striped table-bordered" id="slidersTable">
            <thead>
              <tr>
                <th>ID</th>
                <th>Name</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="btn-group">
                    <a href="{{ route('admin.sliders.show', $item->id) }}" class="btn btn-sm btn-info">
