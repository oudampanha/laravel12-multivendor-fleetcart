...
@section('pageTitle', 'Menu Items Management')
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Menu Items Management</h4>
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table class="table table-striped table-bordered" id="menu_itemsTable">
            <thead>
              <tr>
                <th>ID</th>
                <th>Name</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="btn-group">
                    <a href="{{ route('admin.menu-items.show', $item->id) }}" class="btn btn-sm btn-info">
                      <i class="fas fa-eye"></i>
                    </a>
                    <a href="{{ route('admin.menu-items.edit', $item->id) }}" class="btn btn-sm btn-warning">
