...
@section('pageTitle', 'Edit Order Download')
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Edit Order Download</h4>
      ...
      <div class="card-body">
        <form action="{{ route('admin.order-downloads.update', $item->id ?? 0) }}" method="POST" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control @error('download_count') is-invalid @enderror" 
                   id="download_count" name="download_count" value="{{ old('download_count', $item->download_count ?? '') }}">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control @error('downloaded_at') is-invalid @enderror" 
                   id="downloaded_at" name="downloaded_at" value="{{ old('downloaded_at', $item->downloaded_at ?? '') }}">
            @error('downloaded_at')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="form-group">
            <button type="submit" class="btn btn-primary">
              <i class="fas fa-save"></i> Update Order Download
            </button>
            <a href="{{ route('admin.order-downloads.index') }}" class="btn btn-secondary ml-2">
